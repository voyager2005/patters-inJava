public class x
{
    ...
    {
        x object = new x(); 
        // object.lineByLineExecution(); // UNCOMMENT THIS LINE IF YOU WANT TO SEE A LINE BY LINE EXECUTION OF THE CODE
        ...
        *-------*
        ...
        we are going to devide this pattern into many different parts
